...
// Wed Apr 12 13:41:57 2017 by ROOT version 6.06/01
// from TTree tree/H2TauTauTreeProducerTauTau
// found on file: SMS_TChipmStauSnu/H2TauTauTreeProducerTauTau/tree.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("SMS_TChipmStauSnu/H2TauTauTreeProducerTauTau/tree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("SMS_TChipmStauSnu/H2TauTauTreeProducerTauTau/tree.root");
      }
